    ...
    const fetchdatacitywise = async () => {
      ...
      try {
        let response = await axios.get(
          `https://www.admin777.pny-trainings.com/api/city/specialpage/${'top-online-ai-courses-in-pakistan'}`
        );
  ...
  return (
    <>
      <section className="lg:h-[254px] bg-[#152438;] text-white flex flex-col justify-center items-center max-sm:p-5">
        <div className="text-[48px] max-sm:text-[24px] text-center font-semibold">
