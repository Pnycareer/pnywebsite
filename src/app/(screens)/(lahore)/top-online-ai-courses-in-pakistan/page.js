import TopAiCourse from "./TopcourseAi";



export default async function PITB() {
  const metadata = await fetch('https://www.admin777.pny-trainings.com/api/city/specialpage/top-online-ai-courses-in-pakistan', {
    cache: 'no-cache'
  })
