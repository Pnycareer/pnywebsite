    ...
    <div>
      <footer className="footer p-10  text-black bg-gray-200">
        <aside className="lg:w-[361px]">
          <Image src={pnylogonew} alt="" width={159} />
        ...
        <nav className="max-sm:text-sm">
          <header className=" text-black font-bold text-lg">Quick Link</header>
        ...
        <div>
          <h3 className="text-black font-bold text-lg">Courses Offered</h3>
        ...
        <div>
          <h3 className="text-black font-bold text-lg">Language Courses</h3>
        ...
        <nav>
          <h3 className="text-black font-bold text-lg">Short Courses</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div>
            <Image
              ...
              height={100}
            />
            <h3 className="text-black font-bold text-lg">UAE Office</h3>
            <p>
              Sharjah Research, Technology, and Innovation Park, Block B -
              B18-196, Sharjah,United Arab Emirates.
            </p>
          </div>
        </div>
      </footer>
